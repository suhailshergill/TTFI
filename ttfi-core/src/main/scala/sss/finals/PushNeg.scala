...
object PushNeg {
  ...
  implicit def ExpSym_Ctx[repr[_]](implicit e: ExpSym[repr]): ExpSym[Ctx_=>[repr]#τ] = new ExpSym[Ctx_=>[repr]#τ] {
  ...
  import MulSym._
  implicit def MulSym_Ctx[repr[_]](implicit m: MulSym[repr]): MulSym[Ctx_=>[repr]#τ] = new MulSym[Ctx_=>[repr]#τ] {
